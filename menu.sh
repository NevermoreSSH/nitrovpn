...
Name=$(curl -sS https://raw.githubusercontent.com/NevermoreSSH/nitrovpn/main/izin | grep $MYIP | awk '{print $2}')
Exp=$(curl -sS https://raw.githubusercontent.com/NevermoreSSH/nitrovpn/main/izin | grep $MYIP | awk '{print $3}')
...
echo -e "\E[39;1;92m                   ⇱ SCRIPT PREMIUM BY NITRO VPN VPN⇲             \E[0m"
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
echo -e "${BICyan} "                                                                      
...
echo -e "${BICyan}│ ${BOLD}${BLUE}Developer = NITRO VPN VPN                   ${NC}"
