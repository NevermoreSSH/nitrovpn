...
wget -q -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/NevermoreSSH/nitrovpn/main/nginx.conf.txt" 
mkdir -p /home/vps/public_html
wget -q -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/NevermoreSSH/nitrovpn/main/vps.conf.txt"

wget -q -O xraymode.sh https://raw.githubusercontent.com/NevermoreSSH/nitrovpn/main/Xray%20mode/xraymode.sh && chmod +x xraymode.sh && ./xraymode.sh
sleep 1 
wget -q -O xray.conf https://raw.githubusercontent.com/NevermoreSSH/nitrovpn/main/xray.conf.txt && chmod +x xray.conf && ./xray.conf
sleep 1 
